...
const en = {
  ...
  cheekMassageLevel: 'Cheek contact level',
  foreheadSmoothLevel: 'Forehead contact level',
  jawReleaseLevel: 'Jaw release level',
  eyePressLevel: 'Eye press level',
  templeMassageLevel: 'Temple contact level',
  noseBridgeLevel: 'Nose bridge level',
  chinLiftLevel: 'Chin lift level',
  browSmoothLevel: 'Brow smooth level',
  neckSideLevel: 'Neck side level',
  cheekLiftLevel: 'Cheek lift level',
  jawSideLevel: 'Jaw side level',
  eyeBrowLiftLevel: 'Brow lift level',
  jawlineSculptLevel: 'Jawline sculpt level',
  underEyeTapLevel: 'Under-eye tap level',
  nasolabialSmoothLevel: 'Nasolabial level',
  foreheadTapLevel: 'Forehead tap level',
  chinCircularLevel: 'Chin circular level',
  earToShoulderLevel: 'Ear to shoulder level',
  bodyYoga: 'Body Yoga',
  faceYoga: 'Face Yoga',
...
const tr: typeof en = {
  ...
  cheekMassageLevel: 'Yanak temas seviyesi',
  foreheadSmoothLevel: 'Alın temas seviyesi',
  jawReleaseLevel: 'Çene gevşetme seviyesi',
  eyePressLevel: 'Göz bastırma seviyesi',
  templeMassageLevel: 'Şakak temas seviyesi',
  noseBridgeLevel: 'Burun köprüsü seviyesi',
  chinLiftLevel: 'Çene kaldırma seviyesi',
  browSmoothLevel: 'Kaş düzleştirme seviyesi',
  neckSideLevel: 'Boyun yanı seviyesi',
  cheekLiftLevel: 'Yanak kaldırma seviyesi',
  jawSideLevel: 'Çene yana seviyesi',
  eyeBrowLiftLevel: 'Kaş kaldırma seviyesi',
  jawlineSculptLevel: 'Çene hattı seviyesi',
  underEyeTapLevel: 'Göz altı seviyesi',
  nasolabialSmoothLevel: 'Gülüş çizgisi seviyesi',
  foreheadTapLevel: 'Alın dokunuş seviyesi',
  chinCircularLevel: 'Çene daire seviyesi',
  earToShoulderLevel: 'Kulak-omuz seviyesi',
